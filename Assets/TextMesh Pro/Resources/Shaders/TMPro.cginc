...
float4 GetGloWallsCreator.Instanceolor(float d, float scale)
{
	...
	return float4(_GloWallsCreator.Instanceolor.rgb, saturate(_GloWallsCreator.Instanceolor.a * glow * 2));
}
