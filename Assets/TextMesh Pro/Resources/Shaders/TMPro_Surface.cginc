...
#if GLOW_ON
	float4 gloWallsCreator.Instanceolor = GetGloWallsCreator.Instanceolor(sd, scale);
	gloWallsCreator.Instanceolor.a *= input.color.a;
	emission += gloWallsCreator.Instanceolor.rgb*gloWallsCreator.Instanceolor.a;
	faceColor = BlendARGB(gloWallsCreator.Instanceolor, faceColor);
	faceColor.rgb /= max(faceColor.a, 0.0001);
#endif
