...
namespace ErgoShop.POCO
{
    ...
    public abstract class Element : IElement
    {
        ...
        /// </summary>
        [JsonIgnore] public GameObject associated2DObject;

        /// <summary>
        ///     3D Object in 3D View. Either a generated mesh, or a, imported mesh with collider and rigidbody
        /// </summary>
        [JsonIgnore] public GameObject associated3DObject;

        /// <summary>
        ///     measure shown in 2D
        /// </summary>
        [JsonIgnore] public CotationsScript heightCotation;

        /// <summary>
        ///     Text mesh 2d to put in front of the associated2DObject with the element name
        /// </summary>
        [JsonIgnore] public TextMesh text2D;

        /// <summary>
        ///     measure shown in 2D
        /// </summary>
        [JsonIgnore] public CotationsScript widthCotation;
        ...
        public Vector3 MeshSize
        {
            get
            {
                ...
                {
                    if ((this as CharacterElement).Type != CharacterType.OnWheelChair
                        && (this as CharacterElement).Type != CharacterType.WheelChairEmpty)
                ...
                if (associated3DObject.transform.childCount > 0)
                {
                    if (associated3DObject.transform.GetChild(0).GetComponent<MeshFilter>() != null)
                        return associated3DObject.transform.GetChild(0).GetComponent<MeshFilter>().sharedMesh.bounds
                            .size;
                    return associated3DObject.transform.GetChild(0).GetChild(0).GetComponent<MeshFilter>().sharedMesh
                        .bounds.size;
                }
