...
namespace ErgoShop.Cameras
{
    ...
    public class Camera3DMove : MonoBehaviour
    {
        ...
        private Vector3 minBound = new Vector3(-50, 0, -50);
        private Vector3 maxBound = new Vector3(50, 20, 50);
        ...
        public void SetNormalView()
        {
            ...
            if (previousAngle != Vector3.zero)
            {
                transform.localEulerAngles = previousAngle;
            }
        }
        ...
        private void MoveWithArrows()
        {
            ...
            {
                position -= transform.right * -1f * Time.deltaTime * speed;
            }
            if (Input.GetKey(KeyCode.UpArrow))
            {
                position -= transform.forward * -1f * Time.deltaTime * speed;
            }
        ...
        void LateUpdate()
        {
            canRotate = !this.GetComponent<Camera>().orthographic;
